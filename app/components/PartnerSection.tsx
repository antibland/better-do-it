...
export function PartnerSection({
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <h2 className="text-xl font-semibold text-foreground mb-6">Partner</h2>
                ...
                .map((task) => (
                  <div
                    ...
                    className={`flex items-center space-x-3 p-3 border border-gray-200 rounded-lg ${
                      task.isCompleted === 1 ? "bg-green-50" : "bg-muted"
                    }`}
                  >
          ...
          <form onSubmit={onSendInvite}>
            <div className="flex gap-2">
              ...
              <button
                ...
                className="bg-primary hover:bg-primary/90 disabled:bg-muted text-white px-4 py-2 rounded-md text-sm font-medium"
              >
